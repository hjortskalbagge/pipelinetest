...
void NotifySlack(String release = null, boolean success = false, String messageIn = null) {
	...
	slackSend(color: color, channel: '#botlog', attachments: attachments.toString())
